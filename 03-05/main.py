...
if __name__ == '__main__':
    ...
    print("Only bush Quotient = ", container.OnlyBushQuotient());
    print("Only flower Quotient = ", container.OnlyFlowerQuotient());
    print("Only tree Quotient = ", container.OnlyTreeQuotient());
    print('==> Finish')
